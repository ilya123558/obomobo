...
export const CommentsItem = () => {
  ...
  return (
    <li className='w-full mb-[200px]'>
      <div className="flex w-full justify-between">
        <div className="flex items-center">
          <Image src={'/user/resume/comment-img.png'} alt='comment-img' width={36} height={36} className='rounded-full bg-[#D9D9D9]' />
          <h6 className='m-[0px_10px] font-medium text-[17px]'>Sunju malrn</h6>
          <p className='text-[14px] font-medium text-[#808080]'>1 час назад</p>
        </div>
        <div className="">
      ...
      <div className="mt-[15px]">
        <div className=" mb-[10px]">
          {editComment 
            ...
            : <p className='font-normal text-[17px] w-[50%]'>{commentValue}</p>
          }
        </div>
        <div className="flex items-center">
          <button className='transition-all will-change-transform active:scale-90 text-[14px] text-black text-opacity-[0.8]'>Ответить</button>
          <div className="m-[0px_21px] flex items-center">
            ...
            <p className='text-[14px] text-black text-opacity-[0.8] ml-[5px]'>1k</p>
          </div>
          <div className="flex items-center">
            <button onClick={() => setOpenPostCommentsList(!openPostCommentsList)} className='transition-all will-change-transform active:scale-90'>
              <svg width="14" height="15" viewBox="0 0 14 14" fill="none" xmlns="http://www.w3.org/2000/svg">
