...
export const MiniResume: React.FC<IProps> = ({setActiveComponentValue}) => {
  ...
  return (
    <div className='bg-white md:rounded-[10px_0px_0px_10px] rounded-[10px_0px_0px_10px] overflow-hidden col-span-2'>
      <div ref={ref} style={{height}} className='overflow-x-hidden overflow-y-auto scroll-decor pb-[20px]'>
        <div className="p-[10px_15px_0px]">
          <div className='w-full flex items-center 2xl:flex-row flex-col 2xl:text-start text-center mb-[30px]'>
            <Button handleClick={() => {}} className={`rounded-full flex items-center justify-center w-fit h-fit p-[4px] 2xl:mr-[17px] ${style.img_container}`}>
              <Image src={'/user/resume/profile-img.png'} alt='profile-img' width={143} height={143} quality={100} className='hover:scale-95 transition-all rounded-full h-[100px] w-[100px]' />
            </Button>
            <div className="flex flex-col 2xl:items-start items-center">
              <h4 className='text-[18px] font-semibold mb-[8px]'>Taskia jannat iva</h4>
              <p className='text-[#758195] text-[10px] mb-[5px]'>Yesterday at 12:23 PM</p>
              <div className="mb-[14px] text-[14px] flex items-center gap-x-[4px]">
                <svg width="16" height="15" viewBox="0 0 21 19" fill="none" xmlns="http://www.w3.org/2000/svg">
              ...
              <Button handleClick={handleContact} className='bg-green text-white text-[10px] font-semibold p-[3px_30px] rounded-[6px]'>Контакт</Button>
            </div>
          </div>

          <div className="flex flex-col text-[10px] mb-[15px]">
          ...
          <div className="mb-[15px]">
            ...
            <p className='text-[10px] text-black text-opacity-70 mt-[5px]'>
